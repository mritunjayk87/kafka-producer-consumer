...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, AuthRequest> authReqConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AuthRequest> authReqKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, AuthRequest> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(authReqConsumerFactory());
        return factory;
    }
